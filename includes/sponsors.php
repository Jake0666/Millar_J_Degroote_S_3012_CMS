<?php echo '<section class="sponsors">
  <div class="expanded row uncollapse">
    <div class="small-3 medium-2 medium-push-2 float-left text-center column">
